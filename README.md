...
🔍 My interests are robotics and autonomous systems, where I explore topics like optimal control (LQR, LQG), Model Predictive Control (MPC), State estimation (KF, MHE, UKF..), , Machine learning and RL control, and  Optimization Techniques, including Genetic Algorithms (GA), and Particle Swarm Optimization (PSO) and more.
